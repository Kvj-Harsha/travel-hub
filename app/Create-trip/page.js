  ...
  return (
    <div>
      ...
      <div className='sm:px-10 md:px-32 lg:px-56 xl:px-10 px-5 mt:px-10'> 
            ...
            <p mt-3 className='mt-3 text-grey-500 text-xl'>Just provide some basic information and our trip planner will generate a itenarary based on your preference</p>
          <div className='mt-20'>
            <div>
